...
#### <i class="icon-folder-open"></i> Root Directory

#### <i class="icon-folder-open"></i> Rushs

 - <i class="icon-pencil"></i> Document

#### <i class="icon-folder-open"></i> Ressources Directory
...
#### <i class="icon-folder-open"></i> Output Directory
